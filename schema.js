...
export const TOOL_DESCRIPTION = [
  ...
  "",
  "THE DELIVERABLE IS TWO THINGS, EVERY TIME: the on-screen worksheet, and an Excel workbook attached to your reply. The tool result contains a complete Python script with the worksheet data embedded — run it with your code tool exactly as written and attach the .xlsx it produces. This is not optional and not conditional on the user asking; a run without the attached workbook is incomplete. Never re-call the tool to get the file, and never retype the numbers by hand.",
  "",
